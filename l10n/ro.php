...
"File does not exist" => "Fișierul nu există",
...
"Saved" => "Salvat",
"Format filter server is down or misconfigured" => "Serverul pe care rulează filtrul de formate este inaccesibil sau configurat greșit",
"Conversion failed. Check log for details." => "Conversia a eșuat. Verifică logul pentru detalii.",
"Saving..." => "Se salvează...",
...
"Leaving this page in Editor mode might cause unsaved data. It is recommended to use 'Close' button instead." => "Lăsarea acestei pagini în modul Editor ar putea cauza pierderea unor date nesalvate. E recomandată folosirea butonului 'Închide' înainte.",
"Failed to load this document. Please check if it can be opened with an external odt editor. This might also mean it has been unshared or deleted recently." => "Încărcarea acestui document a eșuat. Te rugăm să verifici dacă poate fi deschis cu un editor extern pentru fișiere .odt. Acest lucru mai poate semnala faptul că i-a fost dezactivată partajarea sau a fost recent șters.",
"Save" => "Salvează",
...
"Share link" => "Partajează legătură",
...
"Edit" => "Editează",
"guest" => "invitat",
"MS Word support (requires openOffice/libreOffice)" => "Suport MS Word (necesită Open Office / Libre Office)",
"Local" => "Local",
"openOffice/libreOffice is installed on this server. Path to binary is provided via preview_libreoffice_path in config.php" => "Open Office / Libre Office este instalat pe acest server. Calea către executabil este furnizată prin preview_libreoffice_path în config.php",
"External" => "Extern",
"openOffice/libreOffice is installed on external server running a format filter server" => "Open Office / Libre Office este instalat pe un server extern care rulează un filtru de formate",
"Disabled" => "Dezactivat",
"No MS Word support" => "Fără suport MS Word",
"scheme://domain.tld[:port]" => "scheme://domain.tld[:port]",
"Server URL" => "URL server",
"Apply and test" => "Aplică și testează",
...
"Advanced feature-set" => "Funcționalități avansate",
"(Unstable)" => "(Instabil)"
);
