OC.L10N.register(
    ...
    "Saved" : "Vistað",
    "Format filter server is down or misconfigured" : "Skráasniðasíunarþjónn er niðri eða rangt stilltur",
    "Conversion failed. Check log for details." : "Umbreyting mistókst. Skoðaðu annálinn fyrir nánari upplýsingar .",
    "Saving..." : "Er að vista ...",
    ...
    "Leaving this page in Editor mode might cause unsaved data. It is recommended to use 'Close' button instead." : "Ef farið er af þessari síðu í breytingaham, gætu gögn tapast. Mælt er með því að nota frekar 'Loka'-hnappinn.",
    ...
    "Share" : "Deila",
    "Share with people on other ownClouds using the syntax username@example.com/owncloud" : "Deila með fólki í öðrum ownCloud-skýjum með skipuninni username@example.com/owncloud",
    ...
    "Edit" : "Breyta",
    "guest" : "gestanotandi",
    "MS Word support (requires openOffice/libreOffice)" : "Stuðningur við MS Word (krefst OpenOffice/LibreOffice)",
    "Local" : "Staðvært",
    "openOffice/libreOffice is installed on this server. Path to binary is provided via preview_libreoffice_path in config.php" : "OpenOffice/LibreOffice er uppsett á þessum þjóni. Slóðin á keyrsluskrá er uppgefin með preview_libreoffice_path í config.php",
    "External" : "Utanaðkomandi",
    "openOffice/libreOffice is installed on external server running a format filter server" : "OpenOffice/LibreOffice er uppsett á utanaðkomandi þjóni sem keyrir skráasniðasíunarþjón",
    "Disabled" : "Óvirkt",
    "No MS Word support" : "Enginn stuðningur við MS Word",
    "scheme://domain.tld[:port]" : "skema://lén.is[:gátt]",
    "Server URL" : "Slóð þjóns",
    "Apply and test" : "Virkja og prófa",
    ...
    "Advanced feature-set" : "Þróaðir eiginleikar",
    "(Unstable)" : "(óstöðugt)"
},
