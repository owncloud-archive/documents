...
"Saved" => "נשמר",
"Format filter server is down or misconfigured" => "שרת החלפת פורמט אינו מקוון או לא מקונפג",
...
"Local" => "מקומי",
"openOffice/libreOffice is installed on this server. Path to binary is provided via preview_libreoffice_path in config.php" => "openOffice/libreOffice מותקן על השרת. קישור ל- binary נקבע על בסיס preview_libreoffice_path בקובץ config.php",
"External" => "חיצוני",
...
"Advanced feature-set" => "מערכת אפשרויות מתקדמות",
"(Unstable)" => "(לא יציב)"
);
