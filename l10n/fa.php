...
"File does not exist" => "پرونده وجود ندارد",
...
"Saved" => "ذخیره شد",
"Format filter server is down or misconfigured" => "کارساز پالایهٔ گونه پایین است یا درست پیکربندی نشده",
"Conversion failed. Check log for details." => "گفت‌وگو شکست خورد. برای جزییات، گزارش را ببینید.",
...
"Edit" => "ویرایش",
"guest" => "میهمان",
"MS Word support (requires openOffice/libreOffice)" => "پشتیبانی از ماکروسافت ورد(نیازمند لیبره آفیس/ اپن آفیس)",
"Local" => "محلی",
"openOffice/libreOffice is installed on this server. Path to binary is provided via preview_libreoffice_path in config.php" => "اپن افیس/لیبره آفیس بر روی این سرور نصب شده اند. مسیر دسترسی به کد باینری از طریق preview_libreoffice_path in config.phpموجود می‌باشد. ",
"External" => "خارجی",
"openOffice/libreOffice is installed on external server running a format filter server" => "اوپن‌آفیس/لیبره‌آفیس روی کارساز خارجی که کارساز پالایهٔ گونه را اجرا می‌کند،‌نصب شده",
