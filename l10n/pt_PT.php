...
"Failed to load this document. Please check if it can be opened with an external odt editor. This might also mean it has been unshared or deleted recently." => "Não foi possível carregar este documento. Por favor, verifique se pode ser aberto com um editor odt externo. Também poderá significar que o documento foi eliminado recentemente ou a partilha foi cancelada.",
"Save" => "Guardar",
